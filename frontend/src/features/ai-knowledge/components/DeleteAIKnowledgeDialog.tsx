/**
 * Delete AI knowledge base confirmation dialog.
 */
 ...
 */
export interface DeleteAIKnowledgeDialogProps {
  /**
   * Knowledge base to delete.
   */
  readonly knowledgeBase: AIKnowledgeBase;
   ...
   */
  readonly onConfirm: (knowledgeBase: AIKnowledgeBase) => Promise<void> | void;
}

/**
 * Delete AI knowledge base confirmation dialog.
 */
export function DeleteAIKnowledgeDialog({
  knowledgeBase,
  isOpen,
  isDeleting = false,
  onClose,
  onConfirm,
}: DeleteAIKnowledgeDialogProps): React.JSX.Element | null {
  ...
  /**
   * Handles knowledge base deletion.
   */
  const handleDelete = async (): Promise<void> => {
    setError(undefined);

    try {
      await onConfirm(knowledgeBase);
    } catch {
      setError("Unable to delete the knowledge base. Please try again.");
    }
  };
      ...
      <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <p className="text-sm text-red-600">
            This action cannot be undone. Any documents registered against
            this knowledge base will be deleted along with it.
          </p>
