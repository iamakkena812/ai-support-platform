 ...
 */
export interface CustomerEmptyProps {
  /**
   * Empty state title.
   */
 ...
 * @returns Customer empty component.
 */
export function CustomerEmpty({
  title = "No Customers Found",
  description = "Create your first customer to start managing customer relationships, projects, and support activities.",
  actionLabel = "Create Customer",
  onAction,
}: CustomerEmptyProps): React.JSX.Element {
  return (
