 ...
 */
export interface TeamEmptyProps {
  /**
   * Empty state title.
   */
 ...
 * @returns Team empty component.
 */
export function TeamEmpty({
  title = "No Teams Found",
  description = "Create your first team to organize users, projects, and responsibilities.",
  actionLabel = "Create Team",
  onAction,
}: TeamEmptyProps): React.JSX.Element {
  return (
