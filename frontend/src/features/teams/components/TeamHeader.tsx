 ...
 * @returns Team header component.
 */
export function TeamHeader({
  title = "Teams",
  description = "Manage teams across the Enterprise AI Support Platform.",
  actions,
}: TeamHeaderProps): React.JSX.Element {
  return (
